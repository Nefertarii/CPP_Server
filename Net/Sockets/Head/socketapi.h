...
inline uint32_t Host_to_network_32(uint32_t host32) { return htobe32(host32); }
inline uint16_t Host_to_network_16(uint16_t host16) { return htobe16(host16); }
inline uint64_t Network_to_host_64(uint64_t net64) { return be64toh(net64); }
inline uint32_t Network_to_host_32(uint32_t net32) { return be32toh(net32); }
inline uint16_t Network_to_host_16(uint16_t net16) { return be16toh(net16); }
